...
class common_class():
       ...
       def get_scope_url(cls,session):
           ...
           return sc_url
       @classmethod
       def get_unpack_sql(cls,session):
           sc_url= cls.get_scope_url(session)
